...
$$
E=\textcolor{#a6e3a1}{2\cdot e^{-dp}}\cdot \textcolor{#89b4fa}{(1-e^{-2d})}\cdot\textcolor{#fab387}{\frac{1}{4\pi}\frac{1-g^2}{\left(1+g^2-2g\cos\left(\theta\right)\right)^{3/2}}}
$$
...
- Beer's law (green): Makes the smoke color darker the more density is captured in the raymarching.
